                                       ...
                                       GVariant *options)
{
  ...
  gboolean disable_mouse = FALSE;
  g_variant_lookup (options, "disable-mouse", "b", &disable_mouse);
  g_printerr ("TPO create_instance: title=%s no_xterm_title=%d disable_mouse=%d\n",
                           title ? title : "(null)", no_xterm_title, disable_mouse);
